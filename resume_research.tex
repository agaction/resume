...
\vspace{0.1cm}
\\ \underline{Notable Coursework:} Data Structures, Algorithms, OOP, Deep Learning, Computer Vision, Perception, AI, Computer Architecture, Systems, Databases, Linear Algebra, Vector Calculus, Probability, Statistics
\vspace{0.20cm}
